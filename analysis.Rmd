...
nocause <- ggdag::ggdag(dg2, text = FALSE, use_labels = "label")  + theme_dag() + labs(title = "Assume unmeasured distressing experience
does not affect Belief or Service")
nocause
...
dl2<-ggdag::ggdag_adjustment_set(dpL, node_size = 14, text = FALSE, use_labels = "label") +
  theme(legend.position = "bottom") +
  theme_dag() + ggtitle("Adjustment set for Anxiety causing Belief in God")
dl2
