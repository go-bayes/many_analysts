...
plot_grand_mean_ameR + plot_grand_mean_ordR + plot_annotation(tag_levels = "a",  title = "Religious only model")
yola
...
ggsave(
  ...
  height = 6,
  units = "in",
  filename = "plot_grand_mean_ameR.jpg",
  device = 'jpeg',
  limitsize = FALSE,
  dpi = 1200
)
...
plot_result_ord <- plot_grand_mean_ame + plot_grand_mean_ord+  plot_annotation(tag_levels = "a")
plot_result_ord
