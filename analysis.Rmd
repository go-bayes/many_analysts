...
Ask Suzanne for raw data. Not sure how they rescaled the ordinal report data. Just a comment. I'd never tranform the factors into numbers scaled between 0-1. This leads to a loss of information. 
...
Correlation plots. Note that we need the to model the country level dependences in any correlation matrix, given strong cultural differences
